...
import { getMasterChefContract } from '../../uzo/utils'
...
const Farm: React.FC = () => {
  ...
  const { onRedeem } = useRedeem(getMasterChefContract(uzo))
    ...
    <>
      ...
      <StyledFarm>
        ...
        <StyledInfo>
          ...
          automagically harvest UZO rewards for you!
        </StyledInfo>
        <Spacer size="md" />
        <StyledLink
          target="__blank"
          href={`https://uzoswap.vision/pair/${lpTokenAddress}`}
        >
          {lpTokenName} Info
        </StyledLink>
      </StyledFarm>
