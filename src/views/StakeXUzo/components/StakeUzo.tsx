...
const StakeUzo: React.FC<StakeProps> = ({}) => {
  const tokenName = "UZO"
  ...
  const tokenBalance = useTokenBalance(contractAddresses.uzo[97])
      ...
      <CardContent>
        <StyledCardContentInner>
          <StyledCardHeader>
            ...
            <Label text={`UZO Tokens Available`}/>
          </StyledCardHeader>
          <StyledCardActions>
            {!allowance.toNumber() ? (
              <Button
